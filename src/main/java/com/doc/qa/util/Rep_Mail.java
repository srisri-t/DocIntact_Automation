...
//    public static void main(String args[])
    {
        ...
        String subject = "DocIntact Automation Report";
...
//        String target_dir = System.getProperty("user.dir")+"\\target";
//        String target_dir_zip = System.getProperty("user.dir")+"\\Reports.zip";
        
        TestUtil zip = new TestUtil();
        zip.compressDirectory(logs_dir, logs_dir_zip);
//        TestUtil zip_reports = new TestUtil();
//        zip_reports.compressDirectory(target_dir, target_dir_zip);
        
    	List<String> attachfile = new ArrayList<String>();
		attachfile.add(System.getProperty("user.dir")+"\\target\\cucumber-reports\\report.html");
//		attachfile.add(System.getProperty("user.dir")+"\\Reports.zip");
		attachfile.add(logs_dir_zip);
//		  File file = new File(System.getProperty("user.dir")+"\\logs");
//	        String[] fileList = file.list();
//	        for(String name:fileList)
//	        {
//	        	attachfile.add(System.getProperty("user.dir")+"\\logs\\"+name);
//	         }
